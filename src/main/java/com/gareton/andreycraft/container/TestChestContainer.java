package com.gareton.andreycraft.container;
...
public class TestChestContainer extends Container {
	...
	public TestChestContainer(final int windowId, final PlayerInventory playerInventory, final TestChestTileEntity tileEntity) {
		super(ModContainerTypes.test_chest.get(), windowId);
	...
	private static TestChestTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
	...
	public boolean canInteractWith(PlayerEntity playerIn) {
		return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.test_chest.get());
	}
